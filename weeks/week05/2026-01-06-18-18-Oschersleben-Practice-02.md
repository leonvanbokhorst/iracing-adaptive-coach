...
Your GR86 memory says "turn in here"—but the FF1600 has different grip levels, different weight distribution, and different rotation characteristics. The VRS tip from this morning applies: **brake later, brake less, let the car flow through the kink**.
...
- **Chapter 9 (Braking)**: VRS technique for T1-T2 applies—turn first, brake second
...
![Consistency Heatmap](assets/2026-01-06-18-18-consistency-heatmap.png)

### Lap Evolution

![Lap Evolution](assets/2026-01-06-18-18-lap-evolution.png)
