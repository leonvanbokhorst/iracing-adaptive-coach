...
EXPERT coach uses 4th → 3rd downshift (NO brake pedal) → car rotates smoothly → maintains momentum → faster.
...
- **Engine braking strength** (how much slowing from engine)
- **Forgiveness** (how much mistakes hurt)
...
- EXPERT coach uses different approach (no brake)
...
- You watch EXPERT/alien use 1st gear in a tricky corner
...
→ **See:** Week 04, Session 04 (Lime Rock) for the EXPERT comparison  
...
**Previous Chapter:** [Chapter 6: Slip Angle & Tire Physics](06-slip-angle/README.md)
