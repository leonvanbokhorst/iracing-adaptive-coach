# Chapter 5a: Weight Transfer Physics & Fundamentals

**The foundation: What is weight transfer and why does it matter in the FF1600?**
...
✅ **Weight transfer = redistribution of load** (total weight stays 504 kg)

✅ **Load transfer formula:** (Force × CoG Height) / Wheelbase

✅ **FF1600 amplifies everything:** Lightweight + short wheelbase + high CoG = instant response

✅ **No downforce:** 100% mechanical grip from weight transfer

✅ **Open diff:** Inside rear wheel useless on throttle

✅ **Your tool:** Weight transfer is HOW you create grip where you need it

---

## What's Next

**You've learned the foundation. Now learn the three types:**

- **Longitudinal:** [Chapter 05b](05b-longitudinal-transfer.md) - Braking & acceleration
- **Lateral & Combined:** [Chapter 05c](05c-lateral-combined.md) - Cornering & trail braking
- **Feeling & Reading:** [Chapter 05d](05d-feeling-reading.md) - Feedback loops
...
_"The car's total weight doesn't change. Only where it goes."_ 🏎️⚖️
