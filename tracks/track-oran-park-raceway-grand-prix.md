---
track: "Oran Park Raceway"
layout: "Grand Prix"
location: "Narellan, New South Wales, Australia"
length_km: 2.62
length_mi: 1.63
opened: 1962
type: "road course (historic)"
---
...
- **Pits Bend + Coca-Cola**  
  Dropping into Pits Bend, you want calm, early braking and a line that opens up the entry to Coca-Cola. In the Ray, think: “slow the platform once, then carry.” Over-attacking Pits Bend to “win” T1 just makes you late and narrow into Coca-Cola, which hurts all the way up to the bridge.

- **Coca-Cola corner**  
  This tight right loves drivers who rotate the car early and prioritise getting back to throttle without saw-toothing the steering. Second gear, one clean trail-brake, let the nose bite, then unwind and go. If you’re adding steering at the point where you should be accelerating, you entered too hot.

- **Bridge approach and crossing**  
  The run up to the bridge is about trust. You’re climbing, the track narrows, and your braking references are fencing and marshal posts rather than big boards. In the Ray, arrive a fraction calmer than you think you can get away with, get the car straight before your main brake hit, and accept a slightly conservative crest the first few sessions. Confidence here is built, not forced.

- **Revett and the infield rhythm**  
  The left-right through Revett is where your steering discipline shows. Pick a line that lets the car change direction once, not three times, and use a breath of throttle to keep it stable. The FF1600 will reward a smooth, almost lazy input with surprising minimum speed.

- **Suttons double-apex**  
  This is the money corner. Trail the brake gently into the first apex, feel the front bite, then give yourself a micro-pause mid-corner: a tiny lift, a breath, and then open the wheel to let the car drift towards the second apex. Done right, you’re already rolling into third as you pass it and the Ray slingshots onto the straight; done wrong, you’re either understeering out to the dust or stuck in “waiting for grip” limbo.

- **Brake bias & bumps**  
  Because of the surface character, a slightly more front-biased brake setting can make life easier early in the week—especially into Pits Bend and Coca-Cola. As you start to memorise which bumps you can ignore and which you can’t, easing the bias back a touch lets the Ray rotate more eagerly into the medium-speed stuff without getting too skatey over the bridge landing.
